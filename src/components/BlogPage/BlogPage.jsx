...
/**
 * Criação do componente que é uma página com todos os posts.
 * @returns Um Array Map com uma lista de posts.
 */
function BlogPage() {
    ...
    listaDePostagens.push(
        ...
        new BlogPostModel(
            "Terceira postagem!",
            "https://hotmart.com/media/2017/09/criar-um-blog.png",
            "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi a tortor eu  odio pellentesque ullamcorper. Duis non ipsum mauris. Nullam dolor dui"
        )
    );

    //Definir o Hook para armazenar nas variáveis e "Set..." de modo que 
